...
class Color extends React.Component {
    ...
    render() {
        ...
        return (
            <div class="color-item" key={this.props.index} style={{ border: this.state.status === 'success' ? '3px solid var(--success-color)' : '3px solid transparent' }}>
                <div class="box">
                    <div class="color-preview" style={{ backgroundColor: this.props.color }}></div>
                    <input class="color-input" maxlength="7" placeholder="#000000" value={this.props.color} onChange={(event) => this.update(event)} ></input>

                    <div class="color-counter-container">
                        <div class="color-counter" style={{ backgroundColor: this.state.status === 'success' ? 'var(--success-color)' : null }}>
                            <p class="color-counter-text">
                                {this.props.index + 1}
                            </p>
                        </div>
                    </div>
                ...
                <div class="box">
                    ...
                    <div class="color-button" onClick={() => {
                    ...
                    <div class="color-button" style={{ cursor: this.props.disabled.up ? 'not-allowed' : 'pointer' }} onClick={() => this.props.move(this.props.index, 'up')}>
                    ...
                    <div class="color-button" style={{ cursor: this.props.disabled.down ? 'not-allowed' : 'pointer' }} onClick={() => this.props.move(this.props.index, 'down')}>
                    ...
                    <div class="color-button" style={{ cursor: this.props.disabled.remove ? 'not-allowed' : 'pointer' }} onClick={() => this.props.remove(this.props.index)}>
